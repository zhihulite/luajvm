...
// 实现参考：https://github.com/gdutxiaoxu/NestedLuaWebView/blob/master/NestedLuaWebView/src/main/java/io/github/gdutxiaoxu/NestedLuaWebView/NestedLuaWebView.java
public class NestedLuaWebView extends LuaWebView implements NestedScrollingChild3 {
    ...
    public NestedLuaWebView(LuaContext context) {
        super(context);
    ...
    // 与 NestedScrollView 的实现一致，去除了 overscroll 相关代码
