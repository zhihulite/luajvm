...
public final class CoroThreadLeakTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // SPI 默认实现为虚拟线程；平台线程模式由测试注册的平台实现覆盖（LuajvmTestRunner
        //   经 -Dluajvm.test.platformcoro 分流），core 不再有属性开关
        System.out.println("  线程模式: " + (LuaThread.coroutineThreadsIsVirtual() ? "虚拟线程" : "平台线程"));
        if (LuaThread.coroutineThreadsIsVirtual()) {
